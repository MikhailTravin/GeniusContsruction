(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".top-header__icon")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".top-header__icon")) {
                    bodyLockToggle();
        ...
        function select_select() {
            ...
            optionMenus.forEach(((optionMenu, i) => {
                ...
                if (optionMenu) {
                    ...
                    if (filterRemoveAll) filterRemoveAll.addEventListener("click", (function() {
                        selectTexts.forEach((item => {
        ...
        document.querySelectorAll(".page__product-card").forEach((n => {
            let thumbsSwiper = new core(n.querySelector(".images-product__thumbs"), {
            ...
            new core(n.querySelector(".images-product__slider"), {
                modules: [ Navigation, Pagination, Thumb ],
                thumbs: {
                    swiper: thumbsSwiper
                },
        ...
        let thumbsSwiper = new core(".images-product__thumbs", {
            modules: [ Navigation, Pagination, Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".images-materials ")) new core(".images-materials ", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        if (catalogFavourites) catalogFavourites.forEach((item => {
            item.addEventListener("click", (function(e) {
                item.classList.toggle("_active");
            }));
        }));
        ...
        if (videosWrap) {
            const videoEventHandler = e => {
                ...
                const video = e.target, allVideos = document.querySelectorAll(".slide-video__item");
                ...
                function showBlogItems(filter) {
                    for (let index = 0; index < blogItems.length; index++) {
                        ...
                        if ("all" === filter || !filter) blogItem.classList.remove("_hide"); else {
                            ...
                            if (blogItem.classList.contains("catalog__column_" + filter)) blogItem.classList.remove("_hide");
                        }
                    }
                }
            }
